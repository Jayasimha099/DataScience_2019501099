setwd("D:\\msit2\\DataMining\\Data Mining Assignments\\DM Assignment2")
...
boxplot(ca_data[,1],oh_data[,1],col="blue",main="Jayasimha",names=c("CA houses", "Ohio houses"),ylab="Prices(in thousands)")
hist(ca_data[,1]*1000,breaks=seq(0,3500000,by=500000),col="red",xlab="Prices",ylab="Frequency",main="Jayasimha")

plot(ecdf(ca_data[,1]),verticals=TRUE,do.p=FALSE,xlab="Prices(in thousands)",ylab="Frequency",main="Jayasimha")
...
plot(football[,2],football[,3],xlim=c(0,12),ylim=c(0,12),pch=15,col="red",xlab="2003 Wins",ylab="2004 Wins",main="Jayasimha")
abline(c(0,1))
